<?php
    ...
    class PDF extends FPDF {   
        ...
        function Header() {                         
            ...
            $this->Cell(150, 5, "INGRESOS", 0,1, 'R', 0);      
    ...
    $resultado = $class->consulta("SELECT I.origen, I.destino, I.fecha_actual, I.tarifa0, I.tarifa, I.iva_ingreso, I.descuento_ingreso, I.total_ingreso FROM ingreso I WHERE id = '$_GET[id]'");        
    while ($row = $class->fetch_array($resultado)) { 
        ...
        $pdf->Cell(60, 6, maxCaracter(utf8_decode('FECHA INGRESO:'.$row[2]),50),1,1, 'L',1);    
        $pdf->Ln(3);       
    ...
    $resultado = $class->consulta("SELECT * FROM detalle_ingreso D, productos P WHERE D.id_producto = P.id and D.id_ingreso = '$_GET[id]'");        
    while ($row = $class->fetch_array($resultado)) {                                                       
