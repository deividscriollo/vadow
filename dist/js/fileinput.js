...
(function (factory) {
    ...
    defaultFileActionSettings = {
        ...
        removeClass: 'btn btn-white btn-danger btn-sm btn-round',
        removeTitle: 'Eliminar Archivo',
        // uploadIcon: '<i class="glyphicon glyphicon-upload text-info"></i>',
        // uploadClass: 'btn btn-white btn-success btn-sm btn-round',
        // uploadTitle: 'Subir archivo',
        indicatorNew: '<i class="glyphicon glyphicon-hand-down text-warning"></i>',
        indicatorSuccess: '<i class="glyphicon glyphicon-ok-sign text-success"></i>',
        indicatorError: '<i class="glyphicon glyphicon-exclamation-sign text-danger"></i>',
        indicatorLoading: '<i class="glyphicon glyphicon-hand-up text-muted"></i>',
        indicatorNewTitle: 'Archivo no cargado',
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgSizeTooLarge: 'Archivo "{name}" (<b>{size} KB</b>) excede el tamaño máximo permitido de carga de <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'Debe seleccionar al menos <b>{n}</b> {files} a subir.',
        msgFilesTooMany: 'Número de archivos seleccionados para la carga <b>({n})</b> exceda del límite máximo permitido <b>{m}</b>.',
        ...
        msgInvalidFileType: 'Tipo de archivo no válido "{name}". Only "{types}" archivos son compatibles.',
        msgInvalidFileExtension: 'Extensión no válido para el archivo "{name}". Only "{extensions}" archivos son compatibles.',
        msgUploadAborted: 'La carga de archivos se abortó',
        msgValidationError: 'Error de validacion',
        msgLoading: 'Cargando el archivo {index} de {files} &hellip;',
        msgProgress: 'Cargando el archivo {index} de {files} - {name} - {percent}% terminado.',
        msgSelected: '{n} {files} seleccionado',
        msgFoldersNotAllowed: 'Sólo los archivos de arrastrar y soltar! {n} carpeta(s) caído se saltaban.',
        msgImageWidthSmall: 'Ancho de archivo de imagen "{name}" al menos debe ser {size} px.',
        msgImageHeightSmall: 'Altura del archivo de imagen "{name}" al menos debe ser {size} px.',
        msgImageWidthLarge: 'Ancho de archivo de imagen "{name}" no puede exceder {size} px.',
        msgImageHeightLarge: 'Altura del archivo de imagen "{name}" no puede exceder {size} px.',
        msgImageResizeError: 'No se pudo obtener las dimensiones de la imagen para cambiar el tamaño.',
